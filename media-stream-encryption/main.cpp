...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
    ...
    MediaStreamEncryptionManager* mediaStreamEncryptionManager = new MediaStreamEncryptionManager(hInstance, appId, channelName, token);

    mediaStreamEncryptionManager->Run();
}